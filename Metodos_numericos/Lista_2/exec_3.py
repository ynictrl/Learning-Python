...
#x2 = (b2-[a21x1(1)+a23x3(0)+a24x4(0)+...+a2nxn(0)])/a22
#x3 = (b3-[a31x1(1)+a32x2(1)+a34x4(0)+...+a3nxn(0)])/a33
...
while True:
    ...
    x1.append((B[1] - (A[1][0]*x1[0] + A[1][2]*x0[2] + A[1][3]*x0[3]))/A[1][1])
    x1.append((B[2] - (A[2][1]*x1[1] + A[2][0]*x1[0] + A[2][3]*x0[3]))/A[2][2])
    x1.append((B[3] - (A[3][1]*x1[1] + A[3][2]*x1[2] + A[3][0]*x1[0]))/A[3][3])
